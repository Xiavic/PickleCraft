package net.picklecraft.Modules.SignRank;
...
public class SignRankPlayerListener implements Listener {
    ...
    private final SignRankModule module;
            ...
            if (event.getAction() == Action.RIGHT_CLICK_BLOCK) {
                ...
                if (blockstate instanceof Sign) {
                    ...
                    if (lines[0].equalsIgnoreCase("SignRank")) {
                        if (!lines[1].isEmpty()) {
                            module.promote(event.getPlayer(), lines[1]);
                        } else if (!lines[2].isEmpty()) {
                            module.promote(event.getPlayer(), lines[2]);
                        } else if (!lines[3].isEmpty()) {
                            module.promote(event.getPlayer(), lines[3]);
                        }
                    }
                }
            }
